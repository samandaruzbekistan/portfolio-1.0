...
export const BentoGridItem = ({
  ...
  const leftLists = ["PHP", "Laravel", "Livewire"];
  const rightLists = ["Dart", "Flutter", ".NET"];
    ...
    >
      ...
      <div className={`${id === 6 && "flex justify-center"} h-full`}>
        ...
        >
          ...
          <div className="font-sans font-extralight md:text-xs lg:text-base text-sm text-[#C1C2D3] z-20 w-full">
            {description}
          </div>
          {/* add text-3xl max-w-96 , remove text-neutral-600 dark:text-neutral-300*/}
          {/* remove mb-2 mt-2 */}
          <div
            className={`font-sans text-lg lg:text-3xl font-bold z-20 w-full`}
          >
            {title}
          </div>
          ...
          {/* Tech stack list div */}
          {id === 3 && (
            <div className="flex gap-1 lg:gap-5 w-fit absolute right-2 top-1/2 transform -translate-y-1/2">
              {/* tech stack lists */}
          ...
          {id === 6 && (
            <div className="mt-5 relative">
              ...
              <MagicButton
                title={copied ? "Link nusxalandi!" : "Telegram kanal linki"}
                icon={<IoCopyOutline />}
                position="left"
